...
##########################################################################################################################################################
# Creating slider for if user wants to modify preset ratio to see how prediction may change

# st.slider('Slide to modify parameter!', min_value=0, max_value=10)
...
st.write("##")
st.write("-----------------------------------------")
st.subheader("Make your own Company!")
...
st.write("End of website.  Hope you had fun!")